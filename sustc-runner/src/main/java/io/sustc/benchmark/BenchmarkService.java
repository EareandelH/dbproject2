...
//    @BenchmarkStep(order = 2, description = "Test VideoService#searchVideo(AuthInfo, String, int, int)")//20/20
...
//    @BenchmarkStep(order = 3, description = "Test VideoService#getAverageViewRate(String)")//pass   61/61
...
//    @BenchmarkStep(order = 4, description = "Test VideoService#getHotspot(String)")//56/56
...
//    @BenchmarkStep(order = 11, description = "Test UserService#getUserInfo(long)")//500/500
...
//    @BenchmarkStep(order = 13, description = "Test VideoService#coinVideo(AuthInfo, String)")//511/511
...
//    @BenchmarkStep(order = 14, description = "Test VideoService#likeVideo(AuthInfo, String)")//686/686
...
//    @BenchmarkStep(order = 15, description = "Test VideoService#collectVideo(AuthInfo, String)")//644/644
    ...
    @BenchmarkStep(order = 16, description = "Test VideoService#postVideo(AuthInfo, PostVideoReq)")//184/184
    ...
    @BenchmarkStep(order = 17, description = "Test UserService#register(RegisterUserReq)")//273/273
    ...
    @BenchmarkStep(order = 18, description = "Test VideoService#updateVideoInfo(AuthInfo, String, PostVideoReq)")//184/184
    ...
    @BenchmarkStep(order = 19, description = "Test VideoService#reviewVideo(AuthInfo, String)")//35/21
    ...
    @BenchmarkStep(order = 20, description = "Test side effect of step 17, 18")//6/8
...
//    @BenchmarkStep(order = 21, description = "Test VideoService#deleteVideo(AuthInfo, String)")//55/41
...
//    @BenchmarkStep(order = 22, description = "Test UserService#deleteAccount(AuthInfo, long)")//199/166
...
//    @BenchmarkStep(order = 23, description = "Test UserService#follow(AuthInfo, long)")//87/87
